      ...
      <div className="items-center text-center text-black">
        <div className="flex mt-9 text-gray-700">
          ...
          <div className="flex-1  h-full p-4">
            <h1 className="text-2xl ml-2 text-left epunda-slab-medium mb-6 flex items-center gap-2">
              <svg
            ...
            <div className="mb-6  mt-14">
              <div className="flex flex-col epunda-slab-light space-y-2  p-3">
                <h2 className="text-xl epunda-slab-medium mb-2 text-left">
                  Type
                </h2>
                {["Topwear", "Bottomwear", "Footwear"].map((type) => (
                  <label
                    key={type}
                    className="flex items-center gap-2 text-xl cursor-pointer select-none 
            ...
            {/* Sort By */}
            <div className="mb-6 ">
              <h2 className="text-lg epunda-slab-medium text-left ml-3  mt-12 mb-2">
                Sort By
              </h2>
              <select
                value={sortBy}
          ...
          <div className="flex-4  h-full">
            <div className="flex flex-row justify-between items-center">
              <h1 className="text-2xl text-left mt-4 mb-6 epunda-slab-medium text-gray-500 ml-6">
                ALL <span className="text-gray-800 ml-1">COLLECTIONS ––––</span>{" "}
              </h1>
              <input
                type="text"
                value={searchQuery}
